...
export default function BinaryDecimal() {
  ...
  const [showCalculation, setShowCalculation] = useState(false); // Shows how the decimal number is calculated
  ...
  const steps: Step[] = (() => {
    ...
    // Generates the steps with the calculated powers
  ...
  async function runAnimation() {
    ...
    try {
      ...
      // Table scanning and render calculation steps
